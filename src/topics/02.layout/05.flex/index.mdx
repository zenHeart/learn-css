...
category: 布局基础
tags: [flexbox, flex, layout, css]
description: 详细介绍 CSS Flexbox 弹性布局的核心概念、属性和应用。
keywords: CSS Flexbox, 弹性布局, flex-direction, justify-content, align-items
---
...
下面是一些 Flexbox 布局的交互式演示：

{/* @playground id="flex-basic" mode="demo" */}
...
{/* @playground id="align-content" mode="demo" */}
