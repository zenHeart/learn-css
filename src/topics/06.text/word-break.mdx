---
title: word-break 属性详解
category: 文本处理
tags: [word-break, overflow-wrap, text, css]
description: CSS 文本换行核心属性，区分 word-break 与 overflow-wrap 的使用场景。
keywords: word-break, overflow-wrap, 文本换行, CJK
---
# word-break 属性详解
